...
:inoremap ƒƒ __author__ = "Alijah O'Connor"<cr>__copyright__ = "Copyright 2021, Invitae"<cr>__credits__ = ["Alijah O'Connor"]<cr>__maintainer__ = "Alijah O'Connor"<cr>__email__ = "aoconnor@archerdx.com"<cr>
